...
def openai_api_stream_iter(
    ...
    if "azure" in model_name:
        ...
        client = openai.OpenAI(base_url=api_base or "https://api.openai.com/v1", api_key=api_key)
...
def nvidia_api_stream_iter(model_name, messages, temp, top_p, max_tokens, api_base):
    ...
    response = requests.post(api_base, headers=headers, json=payload, stream=True, timeout=1)
    text = ""
